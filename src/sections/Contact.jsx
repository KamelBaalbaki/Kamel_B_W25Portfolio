...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "baalbaki.kamel@gmail.com",
    href: "mailto:baalbaki.kamel@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+1 (647) 336-6093",
    href: "tel:+16473366093",
  },
  {
    icon: MapPin,
    label: "Location",
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground animate-fade-in animation-delay-200">
            ...
            and let's discuss how we can build something great together.
          </p>
        </div>
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
              ...
              <div className="space-y-4">
                {contactInfo.map((item, idx) => (
                  <a
                    key={idx}
                    href={item.href}
                    className="flex items-center gap-4 p-4 rounded-xl transition-colors hover:bg-primary/5"
                  >
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                Whether you need a full-time developer or a freelancer, let's
                talk!
              </p>
            </div>
          </div>
