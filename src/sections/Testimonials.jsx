...
const testimonials = [
  {
    quote:
      "Kamel is one of the most talented engineers I've worked with. His attention to detail and ability to translate complex requirements into elegant solutions is remarkable.",
    author: "Sarah Chen",
    role: "Tech Lead",
    avatar:
  ...
  {
    quote:
      "Kamel's expertise in React helped us rebuild our entire frontend in record time. His decisions continue to pay dividends.",
    author: "Emily Philip",
  ...
  {
    quote:
      "Not only is Kamel technically brilliant, but he's also a fantastic communicator and team player. He elevated everyone around him.",
    author: "David Noxa",
...
export const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-32 relative overflow-hidden">
      <div
        className="absolute top-1/2 left-1/2 w-[600px] h-[600px] bg-primary/5
